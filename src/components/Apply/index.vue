<template>
  <div class="cart">
    ...
    >
      ...
      <el-table-column prop="workHours" label="预估工时" width="80">
      </el-table-column>

      <el-table-column prop="laborCost" label="预估人工费" width="100">
      </el-table-column>

      <el-table-column prop="product1" label="配件1" width="100">
      </el-table-column>
      <el-table-column prop="product2" label="配件2" width="100">
      </el-table-column>
      <el-table-column prop="product3" label="配件3" width="100">
      </el-table-column>
