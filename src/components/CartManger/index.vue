  ...
  <div class="cart">
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-tag
            v-if=" scope.row.carProperty==0"
            type="danger"
          >未确认</el-tag>
          <el-tag
            v-if=" scope.row.carProperty==1"
            type="success"
          >确认</el-tag>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <el-tag
            v-if=" scope.row.carEqual==0"
            type="danger"
          >未确认</el-tag>
          <el-tag
            v-if=" scope.row.carEqual==1"
            type="success"
          >确认</el-tag>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <el-tag
            v-if=" scope.row.carLicense==0"
            type="danger"
          >未确认</el-tag>
          <el-tag
            v-if=" scope.row.carLicense==1"
            type="success"
          >确认</el-tag>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    delete(arr) {
      ...
      this.$axios.post(cart.delete, { carIds: arr }).then(res => {
        const data = res.data;
        if (data.errCode == 200) {
