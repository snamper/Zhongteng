          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="客户编码">
                ...
                <el-input v-model="selectData.customerId"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="车辆一致性证书状态">
                <el-select
                  v-model="selectData.carEqual"
                  placeholder="请选择"
                >
                  <el-option
                    v-for="item in oStatus"
