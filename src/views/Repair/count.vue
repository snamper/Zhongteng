        ...
        <el-form label-position="left" inline class="demo-table-expand">
          ...
          <el-form-item label="服务站地址">
           ...
           <el-form-item label="结算清单">
            <el-button type="text" label="增值税发票"  @click="openlist">{{ props.row.costlist }}</el-button>
          </el-form-item>

          <el-form-item label="增值税发票">
            <el-button type="text" label="增值税发票"  @click="openinv">{{ props.row.invoice }}</el-button>
          </el-form-item>

           <el-form-item label="付款申请书">
            <el-button type="text" label="增值税发票"  @click="openpayapp">{{ props.row.payapplication }}</el-button>
          </el-form-item>
