<template>
  <el-dialog :title="type" :visible.sync="isShow" @close="closeDialog">
    <el-form :model="datas" ref="ruleForm" :rules="rules">
      <el-row>
        <el-col :span="12">
          <el-form-item prop="deliveryId" label="出库编码" :label-width="formLabelWidth">
            <el-input v-model="datas.deliveryId"></el-input>
          </el-form-item>
        </el-col>

        <el-col :span="12">
          <el-form-item label="销售日期" prop="billingDate" :label-width="formLabelWidth">
            <el-date-picker type="datetime" v-model="datas.billingDate" placeholder="选择日期时间">
            </el-date-picker>
          </el-form-item>
        </el-col>

        <el-col :span="12">
          <el-form-item label="出库日期" prop="deliveryDate" :label-width="formLabelWidth">
            <el-date-picker type="datetime" v-model="datas.deliveryDate" placeholder="选择日期时间">
            </el-date-picker>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item label="客户编码" prop="coustomerId" :label-width="formLabelWidth">
            <el-input v-model="datas.coustomerId"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item prop="custName" label="客户名称" :label-width="formLabelWidth">
            <el-input v-model="datas.custName"></el-input>
          </el-form-item>
        </el-col>

        <el-col :span="12">
          <el-form-item label="单据编号" prop="delBillno" :label-width="formLabelWidth">
            <el-input v-model="datas.delBillno"></el-input>
          </el-form-item>
        </el-col>
...
export default {
  ...
  methods: {
    ...
    send() {
      ...
      $axios.post(outstorage.addOrUpdate, { ...datas }).then(res => {
